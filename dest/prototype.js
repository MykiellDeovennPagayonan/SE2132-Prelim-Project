...
Classroom.prototype.clone = function () {
    let clonedClassroom = new Classroom(this.roomNumber, this.capacity, Object.assign({}, this.teacher), [...this.students], this.airConditioned, this.hasTelevision);
    return clonedClassroom;
};
let classroom = new Classroom(101, 34, {
    firstName: "Junem",
    lastName: "Repollo",
...
let classroomClone = new Classroom(101, 34, {
    firstName: "Junem",
    lastName: "Repollo",
    subject: "Software Component Design",
}, [
